...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/graphSAGE_framework.png}
    \caption{Bidirectional GraphSAGE-LSTM architecture framework for Method E showing the flow from input features through bidirectional GraphSAGE layers, LSTM processing, and final classification.}
